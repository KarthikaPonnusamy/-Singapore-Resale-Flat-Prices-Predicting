...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background:url("https://www.hdwallpapers.in/download/desert_landscape_lake_sunrise_windows_11_4k_hd_windows_11-HD.jpg");
...
<div style='text-align:center'>
    <h1 style='color:#0A0A0A;'>Singapore Resale Flat Prices Predicting</h1>
</div>
...
with tab2:
    ...
    with col3:
        ...
        block = st.text_input('**Enter the block No (Eg:201A)**',value=254)
        ...
        flat_type_val   =   category_mapping[flat_type]
    ...
    with col5:
            ...
            features = {'town':town,
                    ...
                    'storey_upperbound': storey_upper,
                    'storey_lowerbound': storey_lower
            ...
            submit_button = st.button('Predict a price')
    ...
    if submit_button:
        ...
        st.markdown(f"<p style='font-size:40px; color:black; font-weight:bold; text-align:center;'>Resale Price: S${predicted_price}</p>", unsafe_allow_html=True)
